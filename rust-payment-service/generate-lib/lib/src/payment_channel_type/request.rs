...
impl EntityReference for crate::PaymentChannelType {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/payment_channel_type
#[derive(Debug)]
pub struct PaymentChannelTypeRequest<R = crate::PaymentChannelType> {
    query: SelectQuery,
...
impl<R> Clone for PaymentChannelTypeRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> PaymentChannelTypeRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("PaymentChannelType")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> PaymentChannelTypeRequest<T> {
        PaymentChannelTypeRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
        let repository = ctx
            .payment_channel_type_repository()
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for PaymentChannelType is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn name_is_alipay(self) -> Self {
        self.with_name_is("Alipay")
    }

    pub fn with_name_is_alipay(self) -> Self {
        self.with_name_is("Alipay")
    }



    pub fn with_name_is_not_alipay(self) -> Self {
        self.with_name_is_not("Alipay")
    }


    pub fn name_is_we_chat(self) -> Self {
        self.with_name_is("WeChat")
    }

    pub fn with_name_is_we_chat(self) -> Self {
        self.with_name_is("WeChat")
    }



    pub fn with_name_is_not_we_chat(self) -> Self {
        self.with_name_is_not("WeChat")
    }


    pub fn name_is_stripe(self) -> Self {
        self.with_name_is("Stripe")
    }

    pub fn with_name_is_stripe(self) -> Self {
        self.with_name_is("Stripe")
    }



    pub fn with_name_is_not_stripe(self) -> Self {
        self.with_name_is_not("Stripe")
    }



    pub fn code_is_alipa_y(self) -> Self {
        self.with_code_is("ALIPAY")
    }

    pub fn with_code_is_alipa_y(self) -> Self {
        self.with_code_is("ALIPAY")
    }



    pub fn with_code_is_not_alipa_y(self) -> Self {
        self.with_code_is_not("ALIPAY")
    }


    pub fn code_is_wecha_t(self) -> Self {
        self.with_code_is("WECHAT")
    }

    pub fn with_code_is_wecha_t(self) -> Self {
        self.with_code_is("WECHAT")
    }



    pub fn with_code_is_not_wecha_t(self) -> Self {
        self.with_code_is_not("WECHAT")
    }


    pub fn code_is_strip_e(self) -> Self {
        self.with_code_is("STRIPE")
    }

    pub fn with_code_is_strip_e(self) -> Self {
        self.with_code_is("STRIPE")
    }



    pub fn with_code_is_not_strip_e(self) -> Self {
        self.with_code_is_not("STRIPE")
    }
...
impl<R> Default for PaymentChannelTypeRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< PaymentChannelTypeRequest<R> > for SelectQuery {
    fn from(request: PaymentChannelTypeRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< PaymentChannelTypeRequest<R> > for QuerySelection {
    fn from(request: PaymentChannelTypeRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::PaymentChannelType> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>;
    fn save(self, ctx: &'a C) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<teaql_runtime::GraphNode, Self::Error>> + '_>> {
        Box::pin(async move { self.into_entity().save(ctx).await })
    }
}

impl<R: teaql_core::Entity> crate::PurposedQuery<PaymentChannelTypeRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::PaymentChannelType
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::PaymentChannelType::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> PaymentChannelTypeRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
