...
impl EntityReference for crate::PaymentStatusType {
...
#[derive(Debug)]
pub struct PaymentStatusTypeRequest<R = crate::PaymentStatusType> {
    query: SelectQuery,
...
impl<R> Clone for PaymentStatusTypeRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> PaymentStatusTypeRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("PaymentStatusType")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> PaymentStatusTypeRequest<T> {
        PaymentStatusTypeRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for PaymentStatusType is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn name_is_created(self) -> Self {
        self.with_name_is("Created")
    }

    pub fn with_name_is_created(self) -> Self {
        self.with_name_is("Created")
    }



    pub fn with_name_is_not_created(self) -> Self {
        self.with_name_is_not("Created")
    }


    pub fn name_is_paying(self) -> Self {
        self.with_name_is("Paying")
    }

    pub fn with_name_is_paying(self) -> Self {
        self.with_name_is("Paying")
    }



    pub fn with_name_is_not_paying(self) -> Self {
        self.with_name_is_not("Paying")
    }
    ...
    pub fn name_is_refunded(self) -> Self {
        self.with_name_is("Refunded")
    }

    pub fn with_name_is_refunded(self) -> Self {
        self.with_name_is("Refunded")
    }



    pub fn with_name_is_not_refunded(self) -> Self {
        self.with_name_is_not("Refunded")
    }



    pub fn code_is_create_d(self) -> Self {
        self.with_code_is("CREATED")
    }

    pub fn with_code_is_create_d(self) -> Self {
        self.with_code_is("CREATED")
    }



    pub fn with_code_is_not_create_d(self) -> Self {
        self.with_code_is_not("CREATED")
    }


    pub fn code_is_payin_g(self) -> Self {
        self.with_code_is("PAYING")
    }

    pub fn with_code_is_payin_g(self) -> Self {
        self.with_code_is("PAYING")
    }



    pub fn with_code_is_not_payin_g(self) -> Self {
        self.with_code_is_not("PAYING")
    }
    ...
    pub fn code_is_refunde_d(self) -> Self {
        self.with_code_is("REFUNDED")
    }

    pub fn with_code_is_refunde_d(self) -> Self {
        self.with_code_is("REFUNDED")
    }



    pub fn with_code_is_not_refunde_d(self) -> Self {
        self.with_code_is_not("REFUNDED")
    }
...
impl<R> Default for PaymentStatusTypeRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< PaymentStatusTypeRequest<R> > for SelectQuery {
    fn from(request: PaymentStatusTypeRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< PaymentStatusTypeRequest<R> > for QuerySelection {
    fn from(request: PaymentStatusTypeRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::PaymentStatusType> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>;
    fn save(self, ctx: &'a C) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<teaql_runtime::GraphNode, Self::Error>> + '_>> {
        Box::pin(async move { self.into_entity().save(ctx).await })
    }
}

impl<R: teaql_core::Entity> crate::PurposedQuery<PaymentStatusTypeRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::PaymentStatusType
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::PaymentStatusType::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> PaymentStatusTypeRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::PaymentStatusTypeRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
