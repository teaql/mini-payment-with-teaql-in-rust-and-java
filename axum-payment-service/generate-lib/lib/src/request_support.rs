...
pub trait TeaqlRepositoryProvider: TeaqlRuntime {
    ...
    type CachedMerchantRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;

    fn cached_merchant_repository(&self) -> Result<Self::CachedMerchantRepository<'_>, ContextError>;
    type PaymentOrderRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;

    fn payment_order_repository(&self) -> Result<Self::PaymentOrderRepository<'_>, ContextError>;
    ...
    type PaymentStatusTypeRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;

    fn payment_status_type_repository(&self) -> Result<Self::PaymentStatusTypeRepository<'_>, ContextError>;
    type PaymentChannelTypeRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;

    fn payment_channel_type_repository(&self) -> Result<Self::PaymentChannelTypeRepository<'_>, ContextError>;
}
...
impl TeaqlRepositoryProvider for teaql_runtime::UserContext {
    ...
    type CachedMerchantRepository<'a> = teaql_runtime::EntityDataService<'a, crate::runtime::DataServiceExecutor>
    where
        Self: 'a;

    fn cached_merchant_repository(&self) -> Result<Self::CachedMerchantRepository<'_>, ContextError> {
        self.entity_data_service::<crate::runtime::DataServiceExecutor>("CachedMerchant")
    }

    type PaymentOrderRepository<'a> = teaql_runtime::EntityDataService<'a, crate::runtime::DataServiceExecutor>
    where
        Self: 'a;

    fn payment_order_repository(&self) -> Result<Self::PaymentOrderRepository<'_>, ContextError> {
        self.entity_data_service::<crate::runtime::DataServiceExecutor>("PaymentOrder")
    }
    ...
    type PaymentStatusTypeRepository<'a> = teaql_runtime::EntityDataService<'a, crate::runtime::DataServiceExecutor>
    where
        Self: 'a;

    fn payment_status_type_repository(&self) -> Result<Self::PaymentStatusTypeRepository<'_>, ContextError> {
        self.entity_data_service::<crate::runtime::DataServiceExecutor>("PaymentStatusType")
    }

    type PaymentChannelTypeRepository<'a> = teaql_runtime::EntityDataService<'a, crate::runtime::DataServiceExecutor>
    where
        Self: 'a;

    fn payment_channel_type_repository(&self) -> Result<Self::PaymentChannelTypeRepository<'_>, ContextError> {
        self.entity_data_service::<crate::runtime::DataServiceExecutor>("PaymentChannelType")
    }
}
