...
#[teaql(entity = "PaymentChannelType", table = "payment_channel_type_data", data_service = "postgres")]
pub struct PaymentChannelType {
// @source payment_model.xml:87
#[teaql(id)]
    id: u64,
...
#[teaql(relation(target = "PaymentRecord", local_key = "id", foreign_key = "channel_id", many))]
...
impl PaymentChannelType {
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("PaymentChannelType", self.id)
    }
    ...
    pub(crate) async fn save<'a, C>(
        &self,
        ctx: &'a C,
    ) -> Result<teaql_runtime::GraphNode, crate::TeaqlDataServiceError<C::PaymentChannelTypeRepository<'a>>>
    where
        C: crate::TeaqlRepositoryProvider + ?Sized,
    {
        ...
        if has_ledger_change {
            ...
            return Ok(teaql_runtime::GraphNode::new("PaymentChannelType"));
        }
