...
impl E {
    ...
    pub fn cached_merchant<'a>(value: &'a crate::CachedMerchant) -> crate::CachedMerchantExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("CachedMerchant(id={})", value.id()));
        crate::CachedMerchantExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }

    pub fn payment_order<'a>(value: &'a crate::PaymentOrder) -> crate::PaymentOrderExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("PaymentOrder(id={})", value.id()));
        crate::PaymentOrderExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }
    ...
    pub fn payment_status_type<'a>(value: &'a crate::PaymentStatusType) -> crate::PaymentStatusTypeExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("PaymentStatusType(id={})", value.id()));
        crate::PaymentStatusTypeExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }

    pub fn payment_channel_type<'a>(value: &'a crate::PaymentChannelType) -> crate::PaymentChannelTypeExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("PaymentChannelType(id={})", value.id()));
        crate::PaymentChannelTypeExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }
}
